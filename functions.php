...
function theme_setup() {
  ...
  * adding additional menus to the array. */
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'heyross' ),
		'secondary' => __( 'Secondary Navigation', 'heyross' ),
		// 'footer' => __( 'Footer Navigation', 'heyross' )
	) );
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    'loader', //handle
    get_template_directory_uri() . '/js/jquery.waitforimages.min.js', //source
    array( 'jquery', 'plugins' ), //dependencies
    null, // version number
    true //load in footer
  );
  ...
  wp_enqueue_script(
    ...
    array( 'jquery', 'plugins', 'loader', 'flexslider' ), //dependencies
    null, // version number
    true //load in footer
  );
